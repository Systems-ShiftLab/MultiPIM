...
HMCTrafficManager::HMCTrafficManager( const Configuration &config, const vector<Network *> &net)
...
HMCTrafficManager::~HMCTrafficManager()
{
}

void HMCTrafficManager::Init()
{
  _time = 0;
  _sim_state = running;
  _ClearStats( );
...
void HMCTrafficManager::_RetireFlit( Flit *f, int dest )
{
  _deadlock_timer = 0;
...
int  HMCTrafficManager::_IssuePacket( int source, int cl )
{
  return 0;
}

//TODO: Remove stype?
void HMCTrafficManager::_GeneratePacket(int source, int stype, int cl, int time, int subnet, int packet_size, const Flit::FlitType& packet_type, void* const data, int dest)
{
  assert(stype!=0);
