...
class TimingCore : public Core {
    private:
        ...
        uint64_t instrs, readInstrs, writeInstrs, memInstrs, ifetches,offload_instrs, offlod_mem_instrs;
    ...
    public:
        ...
        TimingCore(FilterCache* _l1i, FilterCache* _l1d, uint32_t domain, g_string& _name, bool enable_pim_mode);
