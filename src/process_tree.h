...
class ProcessTreeNode : public GlobAlloc {
    ...
    public:
        ProcessTreeNode(uint32_t _procIdx, uint32_t _groupIdx, bool _inFastForward, bool _inPause, const SyncedFastForwardMode& _syncedFastForward,
            ...
            : patchRoot(_patchRoot), procIdx(_procIdx), groupIdx(_groupIdx), curChildren(0), heartbeats(0), started(false), inFastForward(_inFastForward),inOffloadRegion(false),
        ...
        inline bool isInOffloadRegion() const { return inOffloadRegion; }
