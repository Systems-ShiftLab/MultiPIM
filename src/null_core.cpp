...
void NullCore::LoadFunc(THREADID tid, ADDRINT addr, UINT32 size, BOOL inOffloadRegion) {}
void NullCore::StoreFunc(THREADID tid, ADDRINT addr, UINT32 size, BOOL inOffloadRegion) {}
void NullCore::PredLoadFunc(THREADID tid, ADDRINT addr, BOOL pred, UINT32 size, BOOL inOffloadRegion) {}
void NullCore::PredStoreFunc(THREADID tid, ADDRINT addr, BOOL pred, UINT32 size, BOOL inOffloadRegion) {}


void NullCore::BblFunc(THREADID tid, ADDRINT bblAddr, BblInfo* bblInfo, BOOL inOffloadRegion) {
