...
map<string, enum HMC::Org> HMC::org_map = {
    ...
    {"HMC_4GB_column1024", HMC::Org::HMC_4GB_column1024},
...
HMC::HMC(Org org, Speed speed, MaxBlock maxblock, LinkWidth linkwidth,
    LaneSpeed lanespeed, int source_links, int hmc_links, int payload_flits) :
    ...
    source_links(source_links), hmc_links(hmc_links), payload_flits(payload_flits),
...
HMC::HMC(const string& org_str, const string& speed_str,
    ...
    const string& lanespeed_str, int source_links, int hmc_links, int payload_flits) :
    HMC(org_map[org_str], speed_map[speed_str], maxblock_map[maxblock_str],
        linkwidth_map[linkwidth_str], lanespeed_map[lanespeed_str], source_links, hmc_links, payload_flits)
{
}
