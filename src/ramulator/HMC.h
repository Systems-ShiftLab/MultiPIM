...
public:
    ...
    HMC(Org org, Speed speed, MaxBlock maxblock, LinkWidth linkwidth, LaneSpeed lanespeed, int source_links, int hmc_links, int payload_flits);
    HMC(const string& org_str, const string& speed_str, const string& maxblock_str, const string& linkwidth_str, const string& lanespeed_str, int source_links, int hmc_links, int payload_flits);
    ...
    int source_links = 0; // number of total host links in source mode, must be power of 2
    int hmc_links = 0; // number of total links per HMC, must be power of 2
